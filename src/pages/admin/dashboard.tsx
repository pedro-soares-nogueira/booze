    ...
    <>
      ...
      <div>
        ...
        <div className='max-w-[1100px] m-auto flex flex-col items-center justify-between py-10 px-4 gap-10'>
          <h1 className='text-2xl font-semibold text-gray-700'>Bem vindo, Boozer admin</h1>
          ...
          <h2 className='text-2xl font-semibold text-gray-700'>Todos os pedidos</h2>
            ...
            {orders.map((order) => {
              ...
              >
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <button className='py-2 bg-green-500 hover:bg-green-700 transition-all text-white rounded-md px-4 text-sm'>
                    Ver Mais
                  </button>
                </div>
              </div>
